...
#import "WTCExpandedCard.h"
#import "WTCModel.h"
#import "WTCBucket.h"
#import "WTCCriticalEvent.h"
#import "InterfaceOrientation.h"

@interface WTCExpandedCard()


@end

@implementation WTCExpandedCard{
    UIView *view;
}
...
-(void)xibSetup{
    ...
    [self.wtccollectionview registerClass:[WTCExpandedCardCell class] forCellWithReuseIdentifier:@"wtcexpandedcell"];
}
...
-(void)didTapActionImage:(UIView *)targetview{
    if (self.cardDelegate && [self.cardDelegate conformsToProtocol:@protocol(WTCExpandedCardDelegate)]) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    WTCExpandedCardCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"wtcexpandedcell" forIndexPath:indexPath];
    
    if(nil == cell){
        cell = [[WTCExpandedCardCell alloc] init];
    }
