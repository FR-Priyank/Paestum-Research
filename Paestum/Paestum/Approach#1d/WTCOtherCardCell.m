...
@implementation WTCOtherCardCell{
    UIView *view;
...
-(void)didTapAction1{
    if (self.cellDelegate && [self.cellDelegate conformsToProtocol:@protocol(WTCOtherCardCellDelegate)]) {
...
-(void)didTapAction2{
    ...
    [self.actionimg2 setAlpha:bookmarkselected/2];
}
