...
@interface OtherViewController ()<CommunicatorProtocol, WTCOtherCardDelegate,UIActionSheetDelegate>
@property (weak, nonatomic) IBOutlet WTCOtherCard *placeholderview;
