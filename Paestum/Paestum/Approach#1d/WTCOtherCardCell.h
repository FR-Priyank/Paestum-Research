...
@protocol WTCOtherCardCellDelegate <NSObject>

@optional
-(void)didTapActionImage:(UIView *)cell;
@end

@interface WTCOtherCardCell : UICollectionViewCell
...
@property (nonatomic, assign)id <WTCOtherCardCellDelegate> cellDelegate;
