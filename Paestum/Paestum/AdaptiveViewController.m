...
@interface AdaptiveViewController ()<CommunicatorProtocol, WTCExpandedCardDelegate,UIActionSheetDelegate>
@property (weak, nonatomic) IBOutlet WTCExpandedCard *placeholderview;
