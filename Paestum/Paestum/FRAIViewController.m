...
@implementation FRAIViewController
...
- (void)setBackgroundOpacity:(float)background_Opacity{
    ...
    if (self.backgroundView) {
        [self.backgroundView setBackgroundColor:[[UIColor blackColor] colorWithAlphaComponent:background_Opacity]];
    }
}
...
-(void)loadAllRequiredView
{
    ...
    if(self.containerView != nil)
    {
        ...
        UIActivityIndicatorView *actIndctr  = [[UIActivityIndicatorView alloc]initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
        actIndctr.frame                     = CGRectMake(placeHolderView.frame.size.width/2 - 37/2, placeHolderView.bounds.origin.y + 20, 37, 37); // 37 is the default width and height of indicator
        actIndctr.hidden                    = NO;
